...
- token-scoped Codex setup from the API key page, with automatic Windows/macOS detection, strict UTF-8 preservation, protected key-file authentication, pre/post Codex validation, and automatic rollback around one-command configuration
