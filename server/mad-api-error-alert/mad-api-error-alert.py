...
DB_PATH = os.environ.get("MAD_API_DB", "/opt/new-api/data/one-api.db")
STATE_DIR = Path(os.environ.get("MAD_API_ALERT_STATE_DIR", "/var/lib/mad-api-error-alert"))
RECIPIENT = os.environ.get("MAD_API_ALERT_RECIPIENT", "huangzeyu66@qq.com")
ERROR_TYPE = 5
SUCCESS_TYPE = 2
TOPUP_TYPE = 1
TRIGGER_COUNT = 5
