...
- the MIT-licensed CPA Responses translation path is embedded in NewAPI's `/codex/v1` compatibility controller, so authentication, billing, channel selection, retries, provider adaptation, and settlement happen in the correct order
